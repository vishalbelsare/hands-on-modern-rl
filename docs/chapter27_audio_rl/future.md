# 27.3 多模态音频 Agent 与未来方向

> [27.2](./reward-design) 讲了音频奖励设计。本节看音频 RL 的前沿——多模态音频 Agent（Step-Audio-Chat、Qwen2-Audio）、实时语音对话（GPT-4o Voice）、以及未来方向。
...
下一章 [第 31 章](../construction) 我们讨论多智能体协作 RL——当多个 LLM agent 协同完成任务时，credit assignment 和奖励分配的挑战。
