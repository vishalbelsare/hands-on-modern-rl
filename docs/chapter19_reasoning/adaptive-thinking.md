# 10.5 自适应思考 与 Claude Opus 4.6 的旗舰案例
...
Opus 4.6 的 AI Research Eval Suite 已经展示了这个趋势——推理模型不只是"思考"，还能"执行"（写代码、跑实验、分析结果）。这与 [第 12 章 Agentic RL](../chapter22_agentic/intro) 深度融合。未来推理模型将变成"能思考 + 能行动"的完整 agent。
...
- [第 11 章 PRM 与推理时搜索](../chapter18_grpo/grpo-family)——怎么用过程奖励引导推理
- [第 12 章 Agentic RL](../chapter22_agentic/intro)——推理模型如何与工具调用结合
- [第 14 章奖励黑客与对齐失败](../chapter15_rlhf/evaluation)——推理模型特有的对齐挑战
