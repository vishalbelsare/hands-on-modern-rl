# 第 16 章 与 未来趋势——从 CartPole 到前沿探索

从第 1 章的 CartPole 到第 9 章的 GRPO，我们走过了现代 RL 的核心旅程。你学会了 Q-Learning 和 DQN 如何让智能体从试错中学习，策略梯度如何直接优化行为，PPO 如何稳定地训练大模型，GRPO 如何用可验证奖励激发推理能力。第 14 章的 Agentic RL 把 RL 从"单轮对话"推进到了"多轮工具交互"。
