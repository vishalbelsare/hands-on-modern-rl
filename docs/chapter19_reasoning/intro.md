# 第 10 章 推理模型与 Test-time Scaling
...
10.4 长 CoT 压缩
     ├── Kimi k1.5 long2short RL
     └── 效率与质量的工程权衡
10.5 Hidden CoT vs Visible CoT
     ├── OpenAI 隐藏推理的工程动机
     ├── DeepSeek-R1 开放推理的策略
     └── 可读性与对齐的取舍
10.6 自适应思考与推理对齐
...
- [第 9 章 GRPO 改进家族](../chapter18_grpo/grpo-family)——R1-Zero 与 DAPO 的训练细节
- [第 9 章 DeepSeek-R1 与 DAPO](../chapter18_grpo/deepseek-dapo)——纯 RL 训练范式的具体实现
- [第 8 章 RLHF](../chapter15_rlhf/intro)——奖励信号的基础知识

本章后续会指向：

- [第 11 章 PRM 与推理时搜索](../chapter18_grpo/grpo-family)——过程奖励与树搜索
- [第 14 章奖励黑客与对齐失败](../chapter15_rlhf/evaluation)——推理模型特有的 reward hacking
- [第 12 章 Agentic RL](../chapter22_agentic/intro)——推理模型作为智能体的"大脑"
